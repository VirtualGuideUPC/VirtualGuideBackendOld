...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TypePlace',
            fields=[
                ('typeplace_id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            name='TouristicPlace',
            fields=[
                ('touristicplace_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ptouristicplace_id', models.AutoField(primary_key=True, serialize=False)),
